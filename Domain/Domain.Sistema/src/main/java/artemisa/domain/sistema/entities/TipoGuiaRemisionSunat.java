 ...
 *
 */
public class TipoGuiaRemisionSunat extends Generica implements Serializable {

	private static final long serialVersionUID = 5378102861663329739L;
	public TipoGuiaRemisionSunat() {
	}
