 ...
 *
 */
public class TipoObjetoComponente extends Generica implements Serializable{

	private static final long serialVersionUID = -2257626472674284817L;
	public TipoObjetoComponente(){
	}
