 ...
 *
 */
public class TipoGuiaRemision  extends Generica implements Serializable {

	private static final long serialVersionUID = -6595040603296204249L;
	public TipoGuiaRemision() {
	}
