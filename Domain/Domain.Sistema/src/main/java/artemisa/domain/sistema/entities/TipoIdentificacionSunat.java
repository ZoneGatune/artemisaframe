 ...
 *
 */
public class TipoIdentificacionSunat extends Generica implements Serializable {

	private static final long serialVersionUID = -3444160145795835799L;
	public TipoIdentificacionSunat() {
	}
