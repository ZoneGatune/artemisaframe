 ...
 *
 */
public class TipoMensajeDialogo extends Generica implements Serializable {

	private static final long serialVersionUID = -2821955678010517625L;
	public TipoMensajeDialogo() {
	}
